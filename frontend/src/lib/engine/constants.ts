...
/** Border / accent color per item rarity. Follows the familiar gray/green/blue/purple
 * convention (common -> uncommon -> rare -> epic) most players already recognize from other
 * loot-based games, rather than inventing a new palette. */
